/datum/job/civilian/nurse
	...
	entry_message_body = "Denizcileri sağlıklı ve güçlü tutmakla görevlisiniz. Ayrıca ilaç ve tedavi konusunda bir uzmansınız ve küçük cerrahi prosedürler uygulayabilirsiniz. Doktorlara ve yaralı denizcilere yardımcı olmaya çalışın."
