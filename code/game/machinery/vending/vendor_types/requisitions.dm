...
/obj/structure/machinery/cm_vending/sorted/cargo_guns/populate_product_list(scale)
	listed_products = list(
		...
		list("F903A2 Rifle", floor(scale * 30), /obj/item/weapon/gun/rifle/rmc_f90/a_grip, VENDOR_ITEM_REGULAR),
		list("NSG23 Assault Rifle", floor(scale * 30), /obj/item/weapon/gun/rifle/nsg23/no_lock/stripped, VENDOR_ITEM_REGULAR),
		list("M4RA Battle Rifle", floor(scale * 20), /obj/item/weapon/gun/rifle/m4ra, VENDOR_ITEM_REGULAR),
		list("L42A Battle Rifle", floor(scale * 20), /obj/item/weapon/gun/rifle/l42a, VENDOR_ITEM_REGULAR),
		list("L42A3 Marksman Rifle", floor(scale * 1), /obj/item/weapon/gun/rifle/l42a3/marksman, VENDOR_ITEM_REGULAR),
		list("M39 Submachinegun", floor(scale * 60), /obj/item/weapon/gun/smg/m39, VENDOR_ITEM_REGULAR),
		list("MP5A5 Submachine Gun", floor(scale * 30), /obj/item/weapon/gun/smg/mp5/mp5a5, VENDOR_ITEM_REGULAR),
		list("P90 Submachine Gun", floor(scale * 30), /obj/item/weapon/gun/smg/p90, VENDOR_ITEM_REGULAR),
		list("M37A2 Pump Shotgun", floor(scale * 30), /obj/item/weapon/gun/shotgun/pump, VENDOR_ITEM_REGULAR),
		list("HG 37-12 Pump Shotgun", floor(scale * 30), /obj/item/weapon/gun/shotgun/pump/dual_tube/cmb, VENDOR_ITEM_REGULAR),
		...
		list("M48A4 service pistol", floor(scale * 20), /obj/item/weapon/gun/pistol/m1911/socom, VENDOR_ITEM_REGULAR),
		...
		list("Type-88 DMR", 1, /obj/item/storage/box/guncase/svd, VENDOR_ITEM_REGULAR),
...
/obj/structure/machinery/cm_vending/sorted/cargo_ammo/populate_product_list(scale)
	listed_products = list(
		...
		list("M41A Magazine (10x24mm)", floor(scale * 100), /obj/item/ammo_magazine/rifle, VENDOR_ITEM_REGULAR),
		list("F903A2 Magazine (10x24mm)", floor(scale * 100), /obj/item/ammo_magazine/rifle/rmc_f90, VENDOR_ITEM_REGULAR),
		list("NSG23 Magazine (10x24mm)", floor(scale * 100), /obj/item/ammo_magazine/rifle/nsg23, VENDOR_ITEM_REGULAR),
		list("M4RA Magazine (10x24mm)", floor(scale * 60), /obj/item/ammo_magazine/rifle/m4ra, VENDOR_ITEM_REGULAR),
		list("L42A Magazine (10x24mm)", floor(scale * 60), /obj/item/ammo_magazine/rifle/l42a, VENDOR_ITEM_REGULAR),
		list("M39 HV Magazine (10x20mm)", floor(scale * 100), /obj/item/ammo_magazine/smg/m39, VENDOR_ITEM_REGULAR),
		list("MP5A5 Magazine (9mm)", floor(scale * 100), /obj/item/ammo_magazine/smg/mp5, VENDOR_ITEM_REGULAR),
		list("P90 Magazine (5.7x28mm)", floor(scale * 100), /obj/item/ammo_magazine/smg/p90, VENDOR_ITEM_REGULAR),
		list("Box of Buckshot Shells (12g)", floor(scale * 56), /obj/item/ammo_magazine/shotgun/buckshot, VENDOR_ITEM_REGULAR),
		list("Box of Flechette Shells (12g)", floor(scale * 56), /obj/item/ammo_magazine/shotgun/flechette, VENDOR_ITEM_REGULAR),
		list("Box of Shotgun Slugs (12g)", floor(scale * 56), /obj/item/ammo_magazine/shotgun/slugs, VENDOR_ITEM_REGULAR),
		...
		list("M48A4 Magazine (.45ACP)", floor(scale * 100), /obj/item/ammo_magazine/pistol/m1911, VENDOR_ITEM_REGULAR),

		list("ARMOR-PIERCING AMMUNITION", -1, null, null),
		list("M41A MK2 AP Magazine (10x24mm)", floor(scale * 10), /obj/item/ammo_magazine/rifle/ap, VENDOR_ITEM_REGULAR),
		list("F903A2 AP Magazine (10x24mm)", floor(scale * 6), /obj/item/ammo_magazine/rifle/rmc_f90/ap, VENDOR_ITEM_REGULAR),
		list("NSG23 AP Magazine (10x24mm)", floor(scale * 6), /obj/item/ammo_magazine/rifle/nsg23/ap, VENDOR_ITEM_REGULAR),
		...
		list("L42A Extended Magazine (10x24mm)", floor(scale * 10), /obj/item/ammo_magazine/rifle/l42a/extended, VENDOR_ITEM_REGULAR),
		...
		list("Magazine Box (MP5A5 x 10)", 0, /obj/item/ammo_box/magazine/mp5, VENDOR_ITEM_REGULAR),
		list("Magazine Box (P90 x 10)", 0, /obj/item/ammo_box/magazine/p90, VENDOR_ITEM_REGULAR),
		...
		list("Magazine Box (F903A2 x 10)" , 0, /obj/item/ammo_box/magazine/rmc_f90 , VENDOR_ITEM_REGULAR),
		list("Magazine Box (AP F903A2 x 10)", 0, /obj/item/ammo_box/magazine/rmc_f90/ap, VENDOR_ITEM_REGULAR),
		list("Magazine Box (NSG23 x 10)", 0, /obj/item/ammo_box/magazine/nsg23, VENDOR_ITEM_REGULAR),
		list("Magazine Box (AP NSG23 x 10)", 0, /obj/item/ammo_box/magazine/nsg23/ap, VENDOR_ITEM_REGULAR),
		...
		list("Magazine Box (Ext L42A x 16)", 0, /obj/item/ammo_box/magazine/l42a/ext, VENDOR_ITEM_REGULAR),
		...
		list("Magazine Box (M1911 x 16)", 0, /obj/item/ammo_box/magazine/m1911, VENDOR_ITEM_REGULAR),
...
/obj/structure/machinery/cm_vending/sorted/attachments/populate_product_list(scale)
	listed_products = list(
		...
		list("B11 Suppressor", 6.5, /obj/item/attachable/scope/mini/nsg23, VENDOR_ITEM_REGULAR),
		...
		list("NSG 2x Telescopic Mini-Scope", 4.5, /obj/item/attachable/scope/mini/nsg23, VENDOR_ITEM_REGULAR),
...
/obj/structure/machinery/cm_vending/sorted/uniform_supply
	...
	listed_products = list(
		...
		list("M3-VL Pattern Light Armor", 10, /obj/item/clothing/suit/storage/marine/light/vest, VENDOR_ITEM_REGULAR),
