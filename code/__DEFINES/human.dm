...
#define RELIGION_SUNNI "İslam (Sünni)"
#define RELIGION_SHIA "İslam (Şii)"
#define RELIGION_PROTESTANT "Hristiyanlık (Protestanlık)"
#define RELIGION_CATHOLIC "Hristiyanlık (Katolik)"
#define RELIGION_ORTHODOX "Hristiyanlık (Ortodoks)"
#define RELIGION_MORMONISM "Hristiyanlık (Mormonluk)"
#define RELIGION_CHRISTIANITY_OTHER "Hristiyanlık (Diğer)"
#define RELIGION_JUDAISM "Yahudilik"
#define RELIGION_BUDDHISM "Budizm"
#define RELIGION_HINDUISM "Hinduizm"
#define RELIGION_SIKHISM "Sihizm"
#define RELIGION_SHINTOISM "Şintoizm"
#define RELIGION_WICCANISM "Wiccanizm"
#define RELIGION_PAGANISM "Paganizm (Wicca)"
#define RELIGION_MINOR "Bölgesel Din"
#define RELIGION_ATHEISM "Ateizm"
#define RELIGION_AGNOSTICISM "Agnostisizm"
